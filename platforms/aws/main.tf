...
module "masters" {
  ...
  ign_ca_cert_list_count               = "${local.tectonic_ca_count}"
  ign_ca_cert_pem_list                 = "${module.ignition_masters.ca_cert_pem_list}"
  ign_ca_cert_s3_list                  = "${local.ign_ca_cert_s3_list}"
...
module "workers" {
  ...
  extra_tags                           = "${var.tectonic_aws_extra_tags}"
  ign_ca_cert_list_count               = "${local.tectonic_ca_count}"
  ign_ca_cert_pem_list                 = "${module.ignition_workers.ca_cert_pem_list}"
  ign_ca_cert_s3_list                  = "${local.ign_ca_cert_s3_list}"
