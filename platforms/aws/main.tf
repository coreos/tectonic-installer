...
module "masters" {
  ...
  instance_count_min                   = "${var.tectonic_master_count_min}"
  instance_count_desired               = "${var.tectonic_master_count}"
  instance_count_max                   = "${var.tectonic_master_count_max}"
...
module "workers" {
  ...
  instance_count_min                   = "${var.tectonic_worker_count_min}"
  instance_count_desired               = "${var.tectonic_worker_count}"
  instance_count_max                   = "${var.tectonic_worker_count_max}"
