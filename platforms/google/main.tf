...
module "ignition-masters" {
  ...
  kubeconfig_gcs_location   = "${google_storage_bucket_object.kubeconfig.name}/${google_storage_bucket_object.kubeconfig.name}"
  assets_gcs_location       = "${google_storage_bucket_object.tectonic-assets.name}/${google_storage_bucket_object.tectonic-assets.name}"
