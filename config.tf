...
variable "tectonic_container_images" {
  ...
  default = {
    ...
    hyperkube                    = "quay.io/coreos/hyperkube:v1.8.9_coreos.2"
    ...
    kube_version_operator        = "quay.io/coreos/kube-version-operator:0dcdef046301e49b65eb0cbc1480f4d740ac2359"
...
variable "tectonic_versions" {
  ...
  default = {
    etcd          = "3.1.8"
    kubernetes    = "1.8.9+tectonic.4"
    monitoring    = "1.9.5"
    tectonic      = "1.8.9-tectonic.4"
    tectonic-etcd = "0.0.1"
    cluo          = "0.3.2"
    alm           = "0.3.0"
  }
