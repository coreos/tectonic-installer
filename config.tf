...
variable "tectonic_container_images" {
  ...
  default = {
    ...
    tnc_operator                         = "quay.io/coreos/tectonic-node-controller-operator-dev:0527e15c8674ed00f0655a350ede6be634d0241e"
    ...
    kube_core_renderer                   = "quay.io/coreos/kube-core-renderer-dev:0527e15c8674ed00f0655a350ede6be634d0241e"
    kube_core_operator                   = "quay.io/coreos/kube-core-operator-dev:0527e15c8674ed00f0655a350ede6be634d0241e"
    tectonic_channel_operator            = "quay.io/coreos/tectonic-channel-operator-dev:0527e15c8674ed00f0655a350ede6be634d0241e"
    kube_addon_operator                  = "quay.io/coreos/kube-addon-operator-dev:0527e15c8674ed00f0655a350ede6be634d0241e"
    tectonic_alm_operator                = "quay.io/coreos/tectonic-alm-operator:v0.3.1"
    tectonic_ingress_controller_operator = "quay.io/coreos/tectonic-ingress-controller-operator-dev:0527e15c8674ed00f0655a350ede6be634d0241e"
    tectonic_utility_operator            = "quay.io/coreos/tectonic-utility-operator-dev:0527e15c8674ed00f0655a350ede6be634d0241e"
    tectonic_network_operator            = "quay.io/coreos/tectonic-network-operator-dev:0527e15c8674ed00f0655a350ede6be634d0241e"
  }
}
