...
variable "tectonic_container_images" {
  ...
  default = {
    ...
    hyperkube                    = "quay.io/coreos/hyperkube:v1.9.6_coreos.2"
    ...
    kube_version_operator        = "quay.io/coreos/kube-version-operator-dev:9d103a3e7b6a9eb23c5241dd5b881f2d8682cacb"
...
variable "tectonic_versions" {
  ...
  default = {
    etcd          = "3.1.8"
    kubernetes    = "1.9.6+tectonic.3"
    monitoring    = "1.9.5"
    tectonic      = "1.9.6-tectonic.3"
    tectonic-etcd = "0.0.1"
    cluo          = "0.3.2"
    alm           = "0.4.0"
  }
