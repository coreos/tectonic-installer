...
variable "tectonic_container_images" {
  ...
  default = {
    ...
    bootkube                     = "quay.io/coreos/bootkube-dev:83c4a35355fc0dc69fc26046f927ae8e3727f9e6"
    ...
    console                      = "quay.io/coreos/tectonic-console:v1.9.2"
    ...
    kube_version_operator        = "quay.io/coreos/kube-version-operator:v1.7.3-kvo.2"
