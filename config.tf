...
variable "tectonic_container_images" {
  ...
  default = {
    ...
    console                      = "quay.io/coreos/tectonic-console:v2.6.6"
    ...
    hyperkube                    = "quay.io/coreos/hyperkube:v1.8.6_coreos.0"
    ...
    kube_version_operator        = "quay.io/coreos/kube-version-operator:v1.8.4-kvo.7"
...
variable "tectonic_versions" {
  ...
  default = {
    etcd          = "3.1.8"
    kubernetes    = "1.8.4+tectonic.2"
    monitoring    = "1.9.0"
    tectonic      = "1.8.4-tectonic.3"
    tectonic-etcd = "0.0.1"
    cluo          = "0.2.5"
    alm           = "0.2.1"
  }
