...
variable "tectonic_container_images" {
  ...
  default = {
    hyperkube                       = "quay.io/coreos/hyperkube:v1.6.10_coreos.0"
    ...
    kube_version_operator           = "quay.io/coreos/kube-version-operator:v1.6.10-kvo.1"
    ...
    tectonic_prometheus_operator    = "quay.io/coreos/tectonic-prometheus-operator:v1.3.1"
...
variable "tectonic_versions" {
  ...
  default = {
    ...
    alertmanager  = "v0.7.1"
    monitoring    = "1.3.1"
    kubernetes    = "1.6.10+tectonic.1"
    tectonic      = "1.6.10-tectonic.1"
    tectonic-etcd = "0.0.1"
  }
}
