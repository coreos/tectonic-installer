...
variable "tectonic_container_images" {
  ...
  default = {
    ...
    console                      = "quay.io/coreos/tectonic-console:v2.6.2"
    ...
    tectonic_network_operator    = "quay.io/coreos/tectonic-network-operator-dev:2838097c6c88c0b5a2ac33aded5a771315b3ad33"
  }
}
