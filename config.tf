...
variable "tectonic_container_images" {
  ...
  default = {
    ...
    hyperkube                    = "quay.io/coreos/hyperkube-dev:v1.9.11_coreos.1"
    ...
    kube_version_operator        = "quay.io/coreos/kube-version-operator-dev:5cc80ed881ea155684c136c28f900573e539d419"
...
variable "tectonic_versions" {
  ...
  default = {
    etcd          = "3.1.8"
    kubernetes    = "1.9.11+tectonic.1"
    monitoring    = "1.9.5"
    tectonic      = "1.9.11-tectonic.1"
    tectonic-etcd = "0.0.1"
    cluo          = "0.3.2"
    alm           = "0.4.0"
  }
