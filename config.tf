...
variable "tectonic_container_images" {
  ...
  default = {
    ...
    console                      = "quay.io/coreos/tectonic-console:v5.0.6"
    ...
    hyperkube                    = "quay.io/coreos/hyperkube-dev:v1.8.14_coreos.1"
    ...
    kube_version_operator        = "quay.io/coreos/kube-version-operator-dev:c6cbc9f76a6599294fbb8fb2eac6085bad2296a8"
...
variable "tectonic_versions" {
  ...
  default = {
    etcd          = "3.1.8"
    kubernetes    = "1.8.14+tectonic.1"
    monitoring    = "1.9.5"
    tectonic      = "1.8.14-tectonic.1"
    tectonic-etcd = "0.0.1"
    cluo          = "0.3.2"
    alm           = "0.3.0"
  }
