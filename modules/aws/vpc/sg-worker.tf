...
resource "aws_security_group_rule" "worker_ingress_http_from_master" {
  type                     = "ingress"
  security_group_id        = "${aws_security_group.worker.id}"
...
resource "aws_security_group_rule" "worker_ingress_https_from_master" {
  type                     = "ingress"
  security_group_id        = "${aws_security_group.worker.id}"
  source_security_group_id = "${aws_security_group.master.id}"
...
resource "aws_security_group_rule" "worker_ingress_ssh_from_master" {
  type                     = "ingress"
  security_group_id        = "${aws_security_group.worker.id}"
  source_security_group_id = "${aws_security_group.master.id}"
...
resource "aws_security_group_rule" "worker_ingress_http_from_console" {
  type                     = "ingress"
  security_group_id        = "${aws_security_group.worker.id}"
...
resource "aws_security_group_rule" "worker_ingress_https_from_console" {
  type                     = "ingress"
  security_group_id        = "${aws_security_group.worker.id}"
  source_security_group_id = "${aws_security_group.console.id}"
...
resource "aws_security_group_rule" "worker_ingress_https_from_api" {
  type                     = "ingress"
  security_group_id        = "${aws_security_group.worker.id}"
