...
resource "aws_security_group_rule" "master_ingress_https_self" {
  type              = "ingress"
  security_group_id = "${aws_security_group.master.id}"
...
resource "aws_security_group_rule" "master_ingress_https_sg_worker" {
  type              = "ingress"
  security_group_id = "${aws_security_group.master.id}"
...
resource "aws_security_group_rule" "master_ingress_https_sg" {
  type              = "ingress"
  security_group_id = "${aws_security_group.master.id}"
