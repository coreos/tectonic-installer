...
| tectonic_http_proxy_address | "(optional) The HTTP proxy address to set in the environment variables of installed ContainerLinux instances." | string | `` |
| tectonic_https_proxy_address | "(optional) The HTTPS proxy address to set in the environment variables of installed ContainerLinux instances." | string | `` |
...
| tectonic_nfs_config | (optional) Content of NFS configuration file. Example: "OPTS_RPC_MOUNTD=\"8 -N 2 -N 3 -V 4 -V 4.1\"" | string | `` |
