...
| tectonic_ntp_servers | (optional) If left blank, the default Container Linux NTP servers will be used.<br><br>A list of NTP servers to be used for time synchronization on the cluster nodes. | list | `<list>` |
