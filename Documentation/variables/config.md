...
|------|-------------|:----:|:-----:|
| tectonic_s3_bucket_name | (optional) Unique name of the S3 bucket<br><br>If name is not provided the installer will construct the name using "tectonic_cluster_name", current AWS region and "tectonic_base_domain" | string | `` |
