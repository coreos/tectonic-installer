...
| tectonic_k8s_log_verbosity | (optional) Configure the log verbosity of Kubernetes control plane components. Valid options are integers from 0-10, with 10 being most verbose.<br><br>See https://github.com/kubernetes/community/blob/master/contributors/devel/logging.md for more information. | string | `2` |
