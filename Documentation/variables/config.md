...
| tectonic_apiserver_admission_control | A list of admission controllers to enable on the apiserver. For more details: https://kubernetes.io/docs/admin/admission-controllers/ | string | `NamespaceLifecycle,LimitRanger,ServiceAccount,PersistentVolumeLabel,DefaultStorageClass,ResourceQuota,DefaultTolerationSeconds,PodSecurityPolicy` |
