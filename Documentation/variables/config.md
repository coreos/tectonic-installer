...
|------|-------------|:----:|:-----:|
| tectonic_additional_master_node_labels | Specifies additional node labels to be added to master nodes. This correlates to the --node-labels  kubelet flag. All labels required by Tectonic will still be present. Example: `["tier=app", "purpose=data"]` | list | `<list>` |
| tectonic_additional_worker_node_labels | Specifies additional node labels to be added to worker nodes. This translates to the --node-labels  kubelet flag. All labels required by Tectonic will still be present. Example: `["tier=app", "purpose=data"]` | list | `<list>` |
...
| tectonic_http_proxy_address | (optional) HTTP proxy address.<br><br>Example: `http://myproxy.example.com` | string | `` |
| tectonic_https_proxy_address | (optional) HTTPS proxy address.<br><br>Example: `http://myproxy.example.com` | string | `` |
