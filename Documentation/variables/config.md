...
| tectonic_cert_chain | PEM-encoded certificatte chain that will be added to generated certs. Use this if you use a intermediate CA with multiple certificates in the chain. | string | `` |
