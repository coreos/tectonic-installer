...
| tectonic_aws_console_allowed_cidr | "(optional) List of CIDR blocks allowed access to the Tectonic console. The VPC CIDR block is implicitly appended.<br><br>Example:  * `["192.168.0.0/16"]`" | list | `<list>` |
