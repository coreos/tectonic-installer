...
| tectonic_aws_external_master_sg_id | (optional) Security group ID for master nodes. If not set, a security group is created. These groups must have proper ingress/egress rules for installation to be successful. <br><br>Example: `"sg-51530134"` | string | `` |
...
| tectonic_aws_external_worker_sg_id | (optional) Security group ID for worker nodes. If not set, a security group is created. These groups must have proper ingress/egress rules for installation to be successful. <br><br>Example: `"sg-51530134"` | string | `` |
